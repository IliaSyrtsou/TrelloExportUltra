...
var $excel_btn,
addInterval,
columnHeadings = ['List', 'Title', 'Description', 'Quantity', 'Price Total', 'Members', 'Labels', 'Card #', 'Card URL' ];
...
function createExcelExport() {
    ...
    debugger;
    $.getJSON(pluginDataURL, function(pluginData) {
                ...
                $.each(data.cards, function (i, card) {
                    if (card.idList === list_id) {
                        ...
                        if(customFieldsPlugin){
                            ...
                            var customFieldsPluginInCard = card.pluginData.find(function(plugin) {
                                return plugin.idPlugin === customFieldsIdPlugin;
                            });
